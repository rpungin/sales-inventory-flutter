...
class Item extends amplify_core.Model {
  ...
  ItemModelIdentifier get modelIdentifier {
    return ItemModelIdentifier(id: id);
  }
  ...
  String toString() {
    ...
    buffer.write("initialQuantity=" +
        (_initialQuantity != null ? _initialQuantity.toString() : "null") +
        ", ");
    buffer.write("remainingQuantity=" +
        (_remainingQuantity != null ? _remainingQuantity.toString() : "null") +
        ", ");
  ...
  static final amplify_core.QueryModelIdentifier<ItemModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<ItemModelIdentifier>();
  ...
  static final INITIALQUANTITY =
      amplify_core.QueryField(fieldName: "initialQuantity");
  static final REMAININGQUANTITY =
      amplify_core.QueryField(fieldName: "remainingQuantity");
...
class ItemModelIdentifier implements amplify_core.ModelIdentifier<Item> {
  ...
  const ItemModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ItemModelIdentifier && id == other.id;
  }

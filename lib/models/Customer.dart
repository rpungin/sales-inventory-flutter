...
class Customer extends amplify_core.Model {
  ...
  const Customer._internal({required this.id, required name, createdAt, updatedAt}): _name = name, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Customer({String? id, required String name}) {
